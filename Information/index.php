...
//Question16
$Facility16=$conn->prepare("SELECT e.first_name, e.last_name, MIN(w.start_time) AS first_day_work, w.role, e.date_of_birth, e.email_address, SUM(TIMESTAMPDIFF(HOUR, s.start_Time, s.end_Time)) AS total_hours_scheduled
FROM employees e
         JOIN workat w ON e.MCN = w.MCN
...
//Question17
$Facility17=$conn->prepare("SELECT e.first_name, e.last_name, MIN(w.start_time) AS first_day_work, w.role, e.date_of_birth, e.email_address, SUM(TIMESTAMPDIFF(HOUR, s.start_Time, s.end_Time)) AS total_hours_scheduled
FROM employees e
         JOIN workat w ON e.MCN = w.MCN
         INNER JOIN schedule s ON e.MCN = s.MCN
        ...
        <div class="row">
            <div class="col-4 offset-1 col-sm-2">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="./index.php">Infomation</a></li>
