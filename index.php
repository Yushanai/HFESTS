...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a class="nav-link fa-lg" href="Modify/index.php"><span class="fa fa-pencil  "></span>Modify</a></li>
    ...
    <!---------------------------------Content------------------------------------------------------------------>
    <div class="container">
        <div class="row row-content align-items-center"><!--row，align-items-center  是bootstrap的， row-content是自己css的-->
            <!--<div class="col-12 col-sm-4 order-sm-last col-md-3">
            <h3>The following functions can be realized in the Modify web page</h3>
            </div>  -->
            <div class="col col-sm order-sm-first col-md">
            <a href="./modify.php"><h2 class="mt-0">Modify</h2></a>
        ...
        <div class="row row-content align-items-center"><!--row，align-items-center  是bootstrap的， row-content是自己css的-->
           <!-- <div class="col-12 col-sm-4 order-sm-last col-md-3">
            ...
            <div class="col col-sm order-sm-first col-md">
            <a href="./information.php"><h2 class="mt-0">Information</h2></a>
        ...
        <div class="row row-content align-items-center"><!--row，align-items-center  是bootstrap的， row-content是自己css的-->
           <!-- <div class="col-12 col-sm-4 order-sm-last col-md-3">
            ...
            <div class="col col-sm order-sm-first col-md">
            <a href="./schedule.php"><h2 class="mt-0">Schedule</h2></a>
                ...
                <ul>
                    ...
                    <li>Quebec doctor info</li>
                    <li>nurse with the longest working hours</li>
                    <li>list of all the doctors who have been on schedule to work in the last two weeks.(Search by facility)</li>
        ...
        <div class="row row-content align-items-center"><!--row，align-items-center  是bootstrap的， row-content是自己css的-->
           <!-- <div class="col-12 col-sm-4 order-sm-last col-md-3">
            ...
            <div class="col col-sm order-sm-first col-md">
            <a href="./email.php"><h2 class="mt-0">Email</h2></a>
    ...
    <a href="./Modify/Employees/index.php">Employees</a>
    <h1>Welcome!</h1>
    <p>choose one of Table!</p>
